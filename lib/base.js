...
base.getJSON = function(swagger, settings, callback){

     Endpoints.get(swagger, settings, function(err, endpoints){
           callback(null, base.build(swagger, endpoints, settings));
     });
}
